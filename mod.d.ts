...
/// <reference types="https://cdn.jsdelivr.net/gh/DefinitelyTyped/DefinitelyTyped/types/node/index.d.ts" />
...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from an arcsine distribution.
*/
...
interface Constructor {
	...
	*/
	...
	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from an arcsine distribution.
	*
	* @param a - minimum support
	* @param b - maximum support
	* @param options - stream options
